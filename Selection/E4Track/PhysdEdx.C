...
E4Track::PhysdEdx::PhysdEdx(int pdg)
  : pdgcode(0)
  , mass(0)
  , charge(0)
  , sp_KE_range(0)
...
void E4Track::PhysdEdx::SetPdgCode(int pdg){
...
double E4Track::PhysdEdx::densityEffect(double beta, double gamma){
...
double E4Track::PhysdEdx::betaGamma(double KE){
...
double E4Track::PhysdEdx::Landau_xi(double KE, double pitch){
...
double E4Track::PhysdEdx::Get_Wmax(double KE){
  double gamma = (KE/mass)+1.0;
  double beta = TMath::Sqrt(1-(1.0/(gamma*gamma)));
...
double E4Track::PhysdEdx::meandEdx(double KE){
...
double E4Track::PhysdEdx::MPVdEdx(double KE, double pitch){
...
double E4Track::PhysdEdx::IntegratedEdx(double KE0, double KE1, int n){
...
double E4Track::PhysdEdx::RangeFromKE(double KE){

  return IntegratedEdx(0, KE);
}

void E4Track::PhysdEdx::CreateSplines(int np, double minke, double maxke){
...
double E4Track::PhysdEdx::RangeFromKESpline(double KE){
  if (!sp_KE_range){
...
double E4Track::PhysdEdx::KEFromRangeSpline(double range){
  if (!sp_range_KE){
...
double E4Track::PhysdEdx::KEAtLength(double KE0, double tracklength){
...
double E4Track::PhysdEdx::KEtoMomentum(double KE){
  return sqrt(pow(KE, 2) + 2.0 * KE * mass);
}

double E4Track::PhysdEdx::MomentumtoKE(double momentum){
  return sqrt(pow(momentum, 2) + pow(mass, 2)) - mass;
}

void E4Track::PhysdEdx::CreateSplineAtKE(int iKE){
...
double E4Track::PhysdEdx::dEdx_PDF(double KE, double pitch, double dEdx){
...
double E4Track::PhysdEdx::dEdx_Gaus_Sigma(double KE, double pitch){
